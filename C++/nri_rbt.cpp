...
public:
	...
	*/
	...
	node *rl_rotation(node *parent)
	{
	    node *temp;
	    temp = parent->gt;
	    parent->gt = ll_rotation(temp);
	    return rr_rotation(parent);
	}

	// tempsibling, temppar and temp.
	// I am assuming "k" in this code to be the "v" in Professor's slides.
	void black_deficient(node *s, node *p, node *k)
	{
		// I think totally 9 cases.
		// Case 1 of 9: Rb0 (case 1, py is black)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 1 of 9: Rb0 (case 1, py is black)\n";
			//k->color = true; // true = red, false = black.
		}

		// Case 2 of 9: Rb0 (case 2, py is red)
		if (p->color == true)
		{
			std::cout << "black_deficient(): Case 2 of 9: Rb0 (case 2, py is red)\n";
			//p->color = false; // true = red, false = black.
			//k->color = true; // true = red, false = black.
		}


		// Case 3 of 9: Rb1 (case 1)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 3 of 9: Rb1 (case 1)\n";
			//ll_rotation(p);
		}

		// Case 4 of 9: Rb1 (case 2)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 4 of 9: Rb1 (case 2)\n";
			//lr_rotation(p);
		}
		...
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 5 of 9: Rb2\n";
			//lr_rotation(p);
		}
		...
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 6 of 9: Rr(0)\n";
			//ll_rotation(p);
		}

		// Case 7 of 9: Rr(1) (case 1)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 7 of 9: Rr(1) (case 1)\n";
			//lr_rotation(p);
		}

		// Case 8 of 9: Rr(1) (case 2)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 8 of 9: Rr(1) (case 2)\n";
		}

		// Case 9 of 9: Rr(2)
		if (p->color == false)
		{
			std::cout << "black_deficient(): Case 9 of 9: Rr(2)\n";
		}
	}
