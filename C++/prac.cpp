...
int main(int argc, char **argv)
{
    ...
    /*
    // Professor lecture #20 slides tree case - From leaves, level-by-level, left to right, to the root:
    t1.insert_node(25);
    ...
    */
    ...
    /*
    // Professor lecture #20 slides tree case - From root, level-by-level, left to right, to leaves:
    t1.insert_node(10);
