...
values 
(
    1001, 'Lone Survivor', 'R', 'Action', TO_DATE('01-10-2014','MM-DD-YYYY'), 121
);
...
values 
(
    1002, 'Frozen', 'PG', 'Animation', TO_DATE('11-27-2013', 'MM-DD-YYYY'), 108
);
...
values 
(
    1003, 'Paranormal Activity: The Marked Ones', 'R', 'Horror', TO_DATE('01-03-2014', 'MM-DD-YYYY'), 84
);
...
values 
(
    1004, 'American Hustle', 'R', 'Drama', TO_DATE('12-20-2014', 'MM-DD-YYYY'), 129
);
...
values 
(
    1005, 'Saving Mr. Banks', 'PG-13', 'Drama', TO_DATE('12-13-2013', 'MM-DD-YYYY'), 120
);
...
values 
(
    1006, 'Her', 'R', 'Romance', TO_DATE('01-10-2014', 'MM-DD-YYYY'), 120
);
...
values 
(
    1007, 'The Hobbit 2', 'PG-13', 'Action', TO_DATE('12-13-2013', 'MM-DD-YYYY'), 161
);
...
values 
(
    1008, 'The Hunger Games 2', 'PG-13', 'Action', TO_DATE('11-22-2013', 'MM-DD-YYYY'), 146
);
